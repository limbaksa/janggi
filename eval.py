...
def get_eval(FEN):
    ...
    while True:
        ...
        print(line)
        if line.startswith('1-0') or line.startswith('0-1') or line.startswith('1/2-1/2'):
...
if __name__=='__main__':
    print(new_get_eval('6R2/9/1chk3R1/1pp1pepp1/9/9/1PP1P1PP1/1C5C1/4K4/1EHA1AEH1/ b'))